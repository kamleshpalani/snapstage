...
function DeletedAccountBanner() {
  ...
  if (searchParams.get("reason") !== "account_deleted") return null;
  return (
    <div className="bg-amber-50 border border-amber-200 text-amber-800 px-4 py-3 rounded-xl mb-6 text-sm flex items-start gap-2">
      ...
      <span>
        Your account has been removed. Please contact support if you believe
        this is a mistake.
      </span>
    </div>
  );
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2.5 mb-6">
            ...
            <span className="text-2xl font-bold text-gray-900">SnapStage</span>
          </Link>
